...
# 参数设置
API_KEY_ = 'sk-8fa8947722864fd98926148b4497a25d'
AUDIO_RATE = 16000
AUDIO_CHANNELS = 1
CHUNK = 1024
OUTPUT_DIR = "./output"
...
class TextToSpeechSynthesizer:
    ...
    # 移除 get_speaker_by_language 方法，因为 CosyVoice 使用预设音色，不再需要动态选择
...
class MainApp:
    ...
    def process_inference(self, audio_output_path, video_output_path):
        ...
        if self.prompt_text:
            ...
            if output_text:
                # speaker, language = self.tts_synthesizer.get_speaker_by_language(output_text) # CosyVoice 使用预设音色，不再需要动态选择 speaker
